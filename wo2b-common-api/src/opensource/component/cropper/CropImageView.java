...
package opensource.component.cropper;

import opensource.component.cropper.cropwindow.CropOverlayView;
import opensource.component.cropper.cropwindow.edge.Edge;
import opensource.component.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.api_cropper_image_view, this, true);
