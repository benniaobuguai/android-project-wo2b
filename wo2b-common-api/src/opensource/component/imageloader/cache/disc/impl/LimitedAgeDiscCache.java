 ...
 *******************************************************************************/
package opensource.component.imageloader.cache.disc.impl;
...
import opensource.component.imageloader.cache.disc.BaseDiscCache;
...
//	}
	...
	@Override
	public File get(String extraDir, String key)
	{
		File file = super.get(extraDir, key);
		if (file.exists()) {
			boolean cached;
			Long loadingDate = loadingDates.get(file);
			if (loadingDate == null) {
