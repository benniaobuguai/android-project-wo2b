...
import opensource.component.imageloader.core.assist.ImageLoadingListener;
 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link opensource.component.imageloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link opensource.component.imageloader.core.imageaware.ImageAware image aware view} should be reset
...
public final class DisplayImageOptions {
	...
	private final SaveImageOptions saveImageOptions;
	...
	private DisplayImageOptions(Builder builder) {
		...
		saveImageOptions = builder.saveImageOptions;
	}
	...
	public SaveImageOptions getSaveImageOptions()
	{
		return saveImageOptions;
	}
	...
	public static class Builder {
		...
		private SaveImageOptions saveImageOptions = DefaultConfigurationFactory.createSaveImageOptions();
		...
		/**
		 * Stub image will be displayed in {@link opensource.component.imageloader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in {@link opensource.component.imageloader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in {@link opensource.component.imageloader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		...
		/**
		 * {@link opensource.component.imageloader.core.imageaware.ImageAware
		...
		/**
		 * Sets whether {@link opensource.component.imageloader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		 ...
		 * {@link opensource.component.imageloader.core.imageaware.ImageAware image aware view} but
		...
		public Builder saveImageOptions(SaveImageOptions saveOptions) {
			this.saveImageOptions = saveOptions;
			return this;
		}
		...
		public Builder cloneFrom(DisplayImageOptions options) {
			...
			saveImageOptions = options.saveImageOptions;
			return this;
		}
