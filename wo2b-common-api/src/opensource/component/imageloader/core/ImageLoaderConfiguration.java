...
import opensource.component.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import opensource.component.imageloader.core.assist.ImageSize;
import opensource.component.imageloader.core.assist.MemoryCacheUtil;
...
import opensource.component.imageloader.core.download.NetworkDeniedImageDownloader;
import opensource.component.imageloader.core.download.SlowNetworkImageDownloader;
import opensource.component.imageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		baseDirectory = builder.baseDirectory;
	...
	public static class Builder {
		 ...
		 * {@link opensource.component.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link opensource.component.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link opensource.component.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link opensource.component.imageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link opensource.component.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link opensource.component.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link opensource.component.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link opensource.component.imageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link opensource.component.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link opensource.component.imageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (discCache == null) {
				...
				discCache = DefaultConfigurationFactory
						.createDiscCache(context, baseDirectory, discCacheFileNameGenerator, discCacheSize, discCacheFileCount);
			}
			if (memoryCache == null) {
