...
class ImageLoaderEngine {
	...
	void submit(final LoadAndDisplayImageTask task) {
		taskDistributor.execute(new Runnable() {
			...
			public void run() {
				// NOTICE: custom-made.
				String extraDir = task.options.getSaveImageOptions().getExtraDir();
				boolean isImageCachedOnDisc = configuration.discCache.get(extraDir, task.getLoadingUri()).exists();
				initExecutorsIfNeed();
	 ...
	 *
	 * @param imageAware {@link opensource.component.imageloader.core.imageaware.ImageAware} for which display task
	 *                   will be cancelled
	 */
