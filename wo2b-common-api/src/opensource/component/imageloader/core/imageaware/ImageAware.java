 ...
 * through {@link opensource.component.imageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link opensource.component.imageloader.core.assist.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain opensource.component.imageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link opensource.component.imageloader.core.assist.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain opensource.component.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain opensource.component.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain opensource.component.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain opensource.component.imageloader.core.DisplayImageOptions display options}.
	 *
	 ...
	 * {@link opensource.component.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
