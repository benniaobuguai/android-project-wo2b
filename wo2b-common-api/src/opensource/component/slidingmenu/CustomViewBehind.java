package opensource.component.slidingmenu;

import opensource.component.slidingmenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	public int getRightWidthOffset()
	{
		return mRightWidthOffset;
	}

	public void setRightWidthOffset(int rightWidthOffset)
	{
		this.mRightWidthOffset = rightWidthOffset;
	}
...
//			if (x <= content.getLeft())
//				vis = View.INVISIBLE;
//			scrollTo((int) (getRightWidthOffset() - getWidth() + (x - getRightWidthOffset()) * mScrollScale), y);
//		}
//		else if (mMode == SlidingMenu.LEFT_RIGHT)
//		{
//			mContent.setVisibility(x >= content.getLeft() ? View.INVISIBLE : View.VISIBLE);
...
//			{
//				scrollTo(
//						(int) (getRightWidthOffset() - getWidth() + (x - getRightWidthOffset()) * mScrollScale),
//						y);
//			}
//		}
//		if (vis == View.INVISIBLE)
...
//					return content.getLeft();
//				case 2:
//					return content.getLeft() + getRightWidthOffset();
//			}
//		}
//		else if (mMode == SlidingMenu.LEFT_RIGHT)
//		{
