 ...
 * @param <Model>
 */
public abstract class RockyListFragmentActivity<Model> extends RockyAbsFragmentActivity
{
	...
	public void onSupportContentChanged()
	{
		...
		mRockyListView = (PullToRefreshAdapterViewBase<AbsListView>) findViewById(R.id.rocky_listview);
		// Set empty view
...
//		mRockyListView.setOnRefreshListener(new OnRefreshListener<AbsListView>()
//		{
//
//			@Override
...
//			{
//				// Set loading message
//				mEmptyView.setEmptyMessage(R.string.hint_loading);
//				
